...
ActiveRecord::Base.connection.reset_pk_sequence!('leaders')
ActiveRecord::Base.connection.reset_pk_sequence!('scouts')
ActiveRecord::Base.connection.reset_pk_sequence!('dens')
